...
draft: false
language: en
description: Please contact us with any questions
---
  ...
  <div class="max-w-screen-md px-4 mx-auto">
      <form name="contact" data-netlify="true" class="space-y-8">
          ...
          <div class="mt-6 lg:pb-16">
             <button type="submit" class="px-5 py-3 font-bold text-center text-emerald-800 bg-cyan-300 rounded-lg text-md sm:w-fit hover:bg-cyan-800 hover:text-emerald-300 focus:ring-4 focus:outline-none focus:ring-indigo-300 dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800">Send Message</button>
          </div>
      </form>
  </div>
</section>
